...
def compute_knn_differences(
    ...
    """
    Motion detection using OpenCV KNN background subtractor.

    Args:
        video_path (str): Path to input video.
        history (int): Number of frames to build background model. Industry-standard: 500.
        dist2_threshold (float): Distance threshold for pixel matching. Industry-standard: 400.0.
        detect_shadows (bool): Detect shadows to reduce false positives.
